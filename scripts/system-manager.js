...
Hooks.once('tokenActionHudCoreApiReady', async (coreModule) => {
    ...
    SystemManager = class SystemManager extends coreModule.api.SystemManager {
         ...
         * Called by Token Action HUD Core
         * @override
         * @returns {object} The OP system styles
         */
        registerStyles () {
            return {
                template: {
                    class: 'op-style-template-style', // The class to add to first DIV element
                    file: 'op-template-style', // The file without the css extension
